...
<section class="hero">
    <div class="container">
        ...
        <h1>Conectemos</h1>
        <p class="hero-text">¿Interesado en colaborar en proyectos sobre difusión de la ciencia, psicoanálisis, educación, economía o finanzas? Encuéntrame en mis redes.</p>
        <div class="social-grid">
            ...
            <a href="hhttps://github.com/juanluiscc-gif" target="_blank" class="social-card github">
                <i class="fa-brands fa-github"></i>
                <span>GitHub</span>
                <p>Explora mi código</p>
            </a>
            <a href="mailto:juanluiscortescervantes@gmail.com" class="social-card gmail">
                <i class="fa-solid fa-envelope"></i>
                <span>Gmail</span>
